...
export default function Hometabs(props) {
  ...
  return (
    <div className="hometabs-wrapper">
      <div className={`${classes.root} hometabs`} style={{minHeight: "90vh", backgroundColor: "transparent"}}>
      <AppBar position="static" style={{backgroundColor: "rgba(0,0,0,.6)", padding: "0 1em"}}>
